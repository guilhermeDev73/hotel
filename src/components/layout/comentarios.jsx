...
export default function Comentarios() {
    ...
    return (
        ...
        <section className="min-h-[60vh] w-3/3 bg-blue-950 flex flex-col items-center text-white  pt-2 overflow-hidden gap-3 relative">
            ...
            <div className="relative flex w-full max-w-[700px] justify-center hover:scale-105 transition">
                ...
                <section className="flex gap-24 overflow-hidden w-[90%] max-w-[300px] transition-all ease-in-out ">
